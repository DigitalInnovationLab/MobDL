...
def save_image(image, image_name, boxes, masks, class_ids, scores, class_names, filter_classs_names=None,
    ...
    for index, value in enumerate(useful_mask_indices):
        ...
        # Label
        # font = ImageFont.truetype('/data/user/0/com.example.python_test/files/chaquopy/AssetFinder/app/arial.ttf', 15)
        # draw.text((x1, y1), "%s %f" % (label, score), (255, 255, 255), font=font)
